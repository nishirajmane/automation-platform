    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-zinc-400">Log in to your FlowMart account.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between mb-2">
              <label className="block text-sm font-medium text-zinc-400 font-mono">Password</label>
              <Link href="#" className="text-xs text-[#C8F04D] hover:underline font-mono">Forgot?</Link>
            </div>
            <input 
              type="password" 
              value={password}
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#C8F04D] text-black h-12 flex items-center justify-center font-medium hover:bg-[#b5d945] transition-colors mt-2"
          >
